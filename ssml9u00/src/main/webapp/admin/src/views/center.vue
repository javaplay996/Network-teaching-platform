     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='jiaoshi'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="身份证号码" prop="shenfenzhenghaoma">
          <el-input v-model="ruleForm.shenfenzhenghaoma"               placeholder="身份证号码" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
  ...
  methods: {
       ...
       this.$message.error(`年龄应输入整数`);
        return
                                                                                                ...
                                                                                                if( 'jiaoshi' ==this.flag && this.ruleForm.shenfenzhenghaoma&&(!checkIdCard(this.ruleForm.shenfenzhenghaoma))){
        this.$message.error(`身份证号码应输入身份证格式`);
        return
      }
