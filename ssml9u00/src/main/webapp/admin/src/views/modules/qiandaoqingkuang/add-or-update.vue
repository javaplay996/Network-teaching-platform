      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="信息编号" prop="xinxibianhao">
          <el-input v-model="ruleForm.xinxibianhao" 
              placeholder="信息编号" clearable  :readonly="ro.xinxibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="信息编号" prop="xinxibianhao">
              <el-input v-model="ruleForm.xinxibianhao" 
                placeholder="信息编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签到项目" prop="qiandaoxiangmu">
          <el-input v-model="ruleForm.qiandaoxiangmu" 
              placeholder="签到项目" clearable  :readonly="ro.qiandaoxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签到项目" prop="qiandaoxiangmu">
              <el-input v-model="ruleForm.qiandaoxiangmu" 
                placeholder="签到项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinxibianhao = true;
            continue;
	            	            ...
	            	            if(o=='qiandaoxiangmu'){
            this.ruleForm.qiandaoxiangmu = obj[o];
	    this.ro.qiandaoxiangmu = true;
            continue;
          }
	            	            if(o=='faburiqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `qiandaoqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiandaoqingkuangCrossAddOrUpdateFlag = false;
                  this.parent.search();
