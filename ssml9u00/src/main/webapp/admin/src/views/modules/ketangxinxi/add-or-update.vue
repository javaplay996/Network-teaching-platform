<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课堂编号" prop="ketangbianhao">
          <el-input v-model="ruleForm.ketangbianhao" 
              placeholder="课堂编号" clearable  :readonly="ro.ketangbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课堂编号" prop="ketangbianhao">
              <el-input v-model="ruleForm.ketangbianhao" 
                placeholder="课堂编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="类型" prop="leixing">
              <el-input v-model="ruleForm.leixing" 
                placeholder="类型" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="相关文档" prop="xiangguanwendang">
          <file-upload
          tip="点击上传相关文档"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiangguanwendang" label="相关文档" prop="xiangguanwendang">
            <el-button type="text" size="small" @click="download(ruleForm.xiangguanwendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="24">  
                	        ...
                	        ketangbianhao: '',
	                        	        ...
	                        	        jiaoshixingming: '',
	                        	                        	                        	        clicktime: '',
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  rules: {
                  ketangbianhao: [
                            { required: true, message: '课堂编号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  ketangmingcheng: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='ketangbianhao'){
            this.ruleForm.ketangbianhao = obj[o];
	    this.ro.ketangbianhao = true;
            continue;
          }
