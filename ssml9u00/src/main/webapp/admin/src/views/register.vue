  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">网络教学平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="身份证号码" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.shenfenzhenghaoma" autocomplete="off" placeholder="身份证号码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">手机号码</div>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                ...
                                                                                                if(`jiaoshi` == this.tableName && this.ruleForm.shenfenzhenghaoma&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghaoma))){
        this.$message.error(`身份证号码应输入身份证格式`);
        return
      }
